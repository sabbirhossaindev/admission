...
<head>
    ...
    <link rel="stylesheet" href="./otherfile/style.css">
</head>
...
<body>
            ...
            <div class="row justify-content-center">
                <div class="col-11 col-sm-10 col-md-10 col-lg-6 col-xl-5 text-center p-0 mt-3 mb-2">
                    <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                        ...
                        <form id="msform" action="admission_save.php" method="post" enctype="multipart/form-data">
                            <!-- progressbar -->
                            <ul id="progressbar">
                            ...
                            <fieldset>
                                <!-- <div class="form-card">
                                    ...
                                    </div> <label class="fieldlabels">Upload Your Photo:</label> <input type="file" name="pic" accept="image/*"> <label class="fieldlabels">Upload Signature Photo:</label> <input type="file" name="pic2" accept="image/*">
                                </div> -->
    ...
    <script src="./otherfile/index.js"></script>
